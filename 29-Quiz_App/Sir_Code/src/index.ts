...
const quizQuestions: QuizQuestion[] = [
	{
		...
		options: ["var variableName: type", "let variableName: type", "const variableName: type", "All of the above"],
	...
	},
	{
		...
		options: ["interface InterfaceName {}", "class InterfaceName {}", "type InterfaceName = {}", "None of the above"],
	...
	},
	{
		...
		options: ["propertyName?: type", "propertyName: type?", "propertyName! : type", "propertyName: type!"],
...
const radioInputContainer = document.querySelector("#radio-inputs-container") as HTMLDivElement;
const nextBtn = document.querySelector("#next_btn") as HTMLButtonElement;
const quiz_container = document.querySelector("#quiz_container") as HTMLDivElement;
const result_container = document.querySelector("#result_container") as HTMLDivElement;
...
nextBtn.addEventListener("click", () => {
	const selected = document.querySelector(`input[name = "question-${currentInd}"]:checked`) as HTMLInputElement;
